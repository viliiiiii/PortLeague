"""
Django settings for portleague project.
...
ALLOWED_HOSTS = [
    "localhost",
    "127.0.0.1",
    "fyp-cqk1.onrender.com",  # Add your Render domain
...
WSGI_APPLICATION = 'portleague.wsgi.application'
